...
func (o *GetCustomerSourcedLookupTablesResponseDataInner) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varGetCustomerSourcedLookupTablesResponseDataInner)
